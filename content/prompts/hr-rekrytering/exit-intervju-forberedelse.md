...
Hjälper HR eller chef förbereda exit-intervju som faktiskt ger ärliga svar och användbara insikter. Separerar beteendebaserade frågor från värderingsfrågor, hanterar GDPR-aspekter och återrapportering.
...
Anställningstid: [år, månader]
Skäl att sluta (om känt): [ny roll externt, familj, byte av bransch, missnöje]
Förhållande till chefen: [bra, neutralt, spänt]
Genomförare av intervjun: [HR, chefen, extern]
Format: [fysiskt möte, video, skriftligt frågeformulär]
Ska svaren delas med chefen: [ja, anonymiserat, nej]
